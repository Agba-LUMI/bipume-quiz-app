...
var signUp = exports.signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(fullName, activeEmail, activeNumber, desireJambScore, onBipume, joinBipume) {
    var res;
        ...
        case 0:
          ...
          return (0, _axios.default)({
            ...
            data: {
              ...
              desireJambScore: desireJambScore,
              onBipume: onBipume,
              joinBipume: joinBipume
            }
          });
        case 3:
          res = _context.sent;
...
var signUpForm = document.querySelector(".form--signedUp");
if (signUpForm) {
  signUpForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var fullName = document.getElementById("fullName").value;
    var activeEmail = document.getElementById("activeEmail").value;
    var activeNumber = document.getElementById("activeNumber").value;
    var desireJambScore = document.getElementById("desireJambScore").value;
    var onBipume = document.getElementById("onBipume").value;
    var joinBipume = document.getElementById("joinBipume").value;
    (0, _signup.signUp)(fullName, activeEmail, activeNumber, desireJambScore, onBipume, joinBipume);
  });
}
